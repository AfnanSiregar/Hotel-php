    ...
    <div class="row">
      ...
      <nav role="navigation" class="probootstrap-nav hidden-xs">
        <ul class="probootstrap-main-nav">
          ...
          <li class="active"><a href="blog.php">Gallery</a></li>
      ...
      <div class="row">
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="probootstrap-hentry mb30">
            <p><img src="img/bdohihi-deluxe-queen.webp" alt="Free Bootstrap Template by uicookies.com" class="img-responsive"></p>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="probootstrap-hentry mb30">
            <p><img src="img/g2a8970a-king-deluxe.webp" alt="Free Bootstrap Template by uicookies.com" class="img-responsive"></p>
          </div>
        </div>
        <div class="clearfix visible-sm-block"></div>
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="probootstrap-hentry mb30">
            <p><img src="img/g2a9192-queen-executive-med-res.webp" alt="Free Bootstrap Template by uicookies.com" class="img-responsive"></p>
          </div>
        </div>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="probootstrap-hentry mb30">
            <p><img src="img/g2a9415-king-executive-plus-med-res.webp" alt="Free Bootstrap Template by uicookies.com" class="img-responsive"></p>
          </div>
        </div>
        <div class="clearfix visible-sm-block"></div>
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="probootstrap-hentry mb30">
            <p><img src="img/g2a9224-king-executive.webp" alt="Free Bootstrap Template by uicookies.com" class="img-responsive"></p>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="probootstrap-hentry mb30">
            <p><img src="img/g2a9289-queen-executive-plus-med-res.webp" alt="Free Bootstrap Template by uicookies.com" class="img-responsive"></p>
          </div>
        </div>
        <div class="clearfix visible-lg-block visible-md-block"></div>
      </div>
